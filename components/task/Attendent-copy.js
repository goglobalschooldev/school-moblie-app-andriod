...
export default function Attendance({ navigation, route }) {
  ...
  const { attendanceDBCtxDispatch, studentsDBCtx,attendanceDBCtx } = useContext(DataController);
...
// console.log(attendanceDBCtx,"attendanceDBCtx")
  const {
    data: sectionDB,
